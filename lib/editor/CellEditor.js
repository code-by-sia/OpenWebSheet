define(["require", "exports", "../common/constants", "../core/Cell", "../core/Appearance"], function (require, exports, constants_1, Cell_1, Appearance_1) {
    ...
    var CellEditor = (function () {
        ...
        CellEditor.prototype.getFontStyle = function (value) {
            var ret = '';
            if (!value)
                return ret;
            if (value.indexOf('italic'))
                ret += ' italic ';
            if (value.indexOf('underline'))
                ret += ' underline ';
            return ret;
        };
        CellEditor.prototype.getFontWeight = function (value) {
            var ret = '';
            if (!value)
                return ret;
            if (value.indexOf('bold'))
                ret += ' bold ';
            if (value.indexOf('bolder'))
                ret += ' bolder ';
            return ret;
        };
        CellEditor.prototype.getTextDecoration = function (value) {
            if (!value)
                return '';
